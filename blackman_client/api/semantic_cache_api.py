...
class SemanticCacheApi:
    ...
    def get_config_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SemanticCacheConfig]:
        """Get semantic cache configuration for the current account
    ...
    def _get_config_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/semantic-cache/config',
    ...
    def _get_stats_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/semantic-cache/stats',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def invalidate_all(
        ...
        _param = self._invalidate_all_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def invalidate_all_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InvalidateResponse]:
        """Invalidate all cache entries for the current account
    ...
    @validate_call
    def invalidate_all_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _invalidate_all_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/semantic-cache/invalidate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_config(
        ...
        :param semantic_cache_config: (required)
        :type semantic_cache_config: SemanticCacheConfig
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _update_config_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if semantic_cache_config is not None:
            _body_params = semantic_cache_config
