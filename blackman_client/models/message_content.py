...
class MessageContent(BaseModel):
    ...
    """
    # data type: str
    oneof_schema_1_validator: Optional[StrictStr] = Field(default=None, description="Simple text content")
    # data type: List[ContentPart]
    oneof_schema_2_validator: Optional[List[ContentPart]] = Field(default=None, description="Multimodal content (text + images)")
