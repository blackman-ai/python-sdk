...
class TestContentPartOneOf(unittest.TestCase):
    """ContentPartOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContentPartOneOf:
        ...
        """
        model = ContentPartOneOf()
        if include_optional:
            return ContentPartOneOf(
                text = '',
                type = 'text'
            )
        else:
