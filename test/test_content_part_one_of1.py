...
class TestContentPartOneOf1(unittest.TestCase):
    """ContentPartOneOf1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContentPartOneOf1:
        ...
        """
        model = ContentPartOneOf1()
        if include_optional:
            return ContentPartOneOf1(
                image_url = blackman_client.models.image_url.ImageUrl(
                    detail = '', 
                    url = '', ),
                type = 'image_url'
            )
    ...
    def testContentPartOneOf1(self):
        """Test ContentPartOneOf1"""
